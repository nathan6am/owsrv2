      ...
      <div className={cn("w-full max-w-md mb-2", containerClassName)}>
        {label && (
          <span className="flex flex-row items-center mb-1">
            <label
              className={cn(
                "block text-light-200 text-sm font-medium",
            ...
            {optional && (
              <p className="text-xs text-light-400 font-medium ml-1 mt-[2px]">
                (Optional)
              </p>
            )}
          </span>
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              ...
              {
                "border-primary-500 ":
                  (status === "error" || errorText) && !inProgress,
          ...
          <div className="absolute right-2 top-0 bottom-0 h-full w-fit flex flex-row justify-center items-center">
            ...
            {type === "password" && (
              ...
              >
                {showPassword ? (
                  <EyeSlash weight="fill" size={"1.2em"} />
                ) : (
                  <Eye weight="fill" size={"1.2em"} />
                )}
              </button>
            )}
          </div>
        ...
        <div className="h-3 mt-[2px] flex flex-row justify-between">
          {errorText && !inProgress && (
            <p className="text-primary-500 text-xs text-left ">
              {"* " + errorText}
            </p>
          )}
          <>
