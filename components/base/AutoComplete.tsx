          ...
          >
            <Combobox.Options className="absolute mt-1 max-h-60 z-[100] w-full overflow-auto rounded-md bg-elevation-2 py-1  shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
              {filteredOptions.length === 0 && query !== "" ? (
                <div className="relative cursor-default select-none px-4 py-2 text-light-400">
                  Nothing found.
                </div>
              ) : (
                      ...
                      <>
                        <span
                          className={`block truncate ${
                            selected
                              ? "font-medium text-light-100"
                              : "font-normal text-light-300"
                          }`}
                        >
                          {option.label}
                        </span>
