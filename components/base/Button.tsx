  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "h-fit flex flex-row items-center justify-center rounded-md my-2 font-medium transition-colors duration-200 relative",
          {
      ...
      >
        ...
        {inProgress && (
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            {inProgressLabel && <span className="ml-2">{inProgressLabel}</span>}
          </div>
        )}
      </button>
    );
