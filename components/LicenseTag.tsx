  ...
  return (
    <div
      className={cn(
        ...
        {
          "bg-primary-300/[0.2] border-primary-400 text-primary-400":
            license === "R",
          "bg-orange-400/[0.2] border-orange-500 text-orange-500":
            license === "C",
          "bg-yellow-400/[0.2] border-yellow-500 text-yellow-500":
            license === "B",
          "bg-green-400/[0.2] border-green-500 text-green-500": license === "A",
          "bg-fuchsia-500/[0.2] border-fuchsia-600 text-fuchsia-500":
            license === "S",
        }
      )}
    >
