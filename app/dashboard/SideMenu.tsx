...
export default function SideMenu() {
  ...
  return (
    ...
    >
      <div
        className={` z-[5] h-screen  w-[300px] bg-elevation-2 flex flex-col justify-between h-full border-r border-light-500 fixed trasition ease-in-out duration-500 overflow-y-auto ${
          collapse
...
const MenuItem = ({
  ...
  return (
    <Link href={href}>
      <li
        className={cn(
          "cursor-pointer py-4 px-8 flex flex-row group border-l-4 border-transparent",
          {
            "bg-elevation-4 text-light-200 border-primary-400": active,
            "hover:bg-elevation-300 text-light-200 hover:text-light-200":
              !active,
          }
        )}
      >
        <Icon
          className={cn("inline mr-6", {
            ...
            "fill-light-300 text-light-300 group-hover:fill-light-200 group-hover:text-light-200":
              !active,
